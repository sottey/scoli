...
- Render a settings form with sections for Display (dark mode, default view, start on today's note, show templates, show AI node),
  Notes (sort by, sort order), and Email (SMTP config,
